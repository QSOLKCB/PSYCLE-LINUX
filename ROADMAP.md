...
- [ ] tracker commands and delayed/retrigger events;
  ...
  - [x] Add an additive fresh-process render-isolation matrix for the PR #71 access violation: ordinary-note control plus isolated `FD 7F`, `FB 3F`, `FA 42` and `FE 04` sampled witnesses, all using the same sample/routing/timing family and exact original-render UI. This diagnostic lane may localize the crash but cannot classify parity.
