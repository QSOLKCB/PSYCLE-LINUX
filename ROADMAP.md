...
- [ ] tracker commands and delayed/retrigger events;
  ...
  - [ ] Run and version a successful fault-location observation if the hosted Windows image exposes the required debugger evidence; a module offset may narrow the binary region but must not be promoted to a source-function claim without independent symbol/source binding.
