...
static uintptr_t numinputs(const psy_audio_Machine* self) { return 0; }
static uintptr_t numoutputs(const psy_audio_Machine* self) { return 0; }	
...
static void output(const psy_audio_Machine* self, const char* text)
{
	if (self->callback) {
...
static bool addcapture(psy_audio_Machine* self, intptr_t index)
{
	return (self->callback)
...
static bool removecapture(psy_audio_Machine* self, intptr_t index)
{
	return (self->callback)
...
static void readbuffers(psy_audio_Machine* self, intptr_t index,
...
static const char* capturename(const psy_audio_Machine* self, intptr_t index)
{
	return (self->callback)
...
static const char* playbackname(const psy_audio_Machine* self, intptr_t index)
{
	return (self->callback)
...
static uintptr_t numplaybacks(const psy_audio_Machine* self)
{
	return (self->callback)
...
static const char* language(const psy_audio_Machine* self)
{
	return (self->callback)
