...
void psy_audio_machines_connect_insert(psy_audio_Machines*,
	void* context, void* fp);
void psy_audio_machines_connect_removed(psy_audio_Machines*,
	void* context, void* fp);
void psy_audio_machines_connect_slot_change(psy_audio_Machines*,
	void* context, void* fp);

void psy_audio_machines_clone_selection(psy_audio_Machines*,
...
void psy_audio_machines_remove_selection(psy_audio_Machines*,
	uintptr_t* selection, uintptr_t count, bool rewire);
void psy_audio_machines_exchange(psy_audio_Machines*, uintptr_t srcslot,
	uintptr_t dstslot);
void psy_audio_machines_exchange_selection(psy_audio_Machines*,
	uintptr_t* selection, uintptr_t count, bool rewire);
...
void psy_audio_machines_disconnect_all(psy_audio_Machines*, uintptr_t slot);
int psy_audio_machines_connected(psy_audio_Machines*, psy_audio_Wire);
void psy_audio_machines_connect_selection_to(psy_audio_Machines*,
...
void psy_audio_machines_position_random(psy_audio_Machines*,
	struct psy_audio_Machine*, double CW, double CH, double xs, double ys);
