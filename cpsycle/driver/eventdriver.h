...
#define PSY_EVENTDRIVER_EVJOYSTICK_GUID 0x0021
...
INLINE psy_EventDriverCmd psy_eventdrivercmd_make_id(int id)
{
...
INLINE intptr_t psy_eventdrivercmd_id(const psy_EventDriverCmd* self)
{
	assert(self);
