...
static intptr_t addcaptureport(CWasapiDriver* self, intptr_t idx);
static intptr_t removecaptureport(CWasapiDriver* self, intptr_t idx);
...
{
	const CWasapiDriver* self;
	
	self = (const CWasapiDriver*)driver;
	std::vector<std::string> ports;
...
intptr_t removecaptureport(CWasapiDriver* self, intptr_t idx)
{
	return self->wasapiif->RemoveCapturePort(idx);
}

intptr_t addcaptureport(CWasapiDriver* self, intptr_t idx)
{
