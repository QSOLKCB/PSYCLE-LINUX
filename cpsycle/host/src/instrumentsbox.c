...
static void instrumentsbox_on_instrument_removed(InstrumentsBox*,
	psy_ui_Component* sender, const psy_audio_InstrumentIndex* slot);
static void instrumentsbox_on_group_listbox_changed(InstrumentsBox*,
	psy_ui_ListBox* sender);
static void instrumentsbox_on_listbox_changed(InstrumentsBox*,
	psy_ui_ListBox* sender);
...
{		
	...
	psy_signal_connect(&self->grouplist.signal_selchanged, self,
		instrumentsbox_on_group_listbox_changed);
	psy_signal_connect(&self->instrumentlist.signal_selchanged, self,
		instrumentsbox_on_listbox_changed);
}
...
void instrumentsbox_on_group_listbox_changed(InstrumentsBox* self,
	psy_ui_ListBox* sender)
{
...
void instrumentsbox_on_listbox_changed(InstrumentsBox* self, psy_ui_ListBox*
	sender)
{
	uintptr_t groupslot;
	...
	psy_audio_instruments_select(self->instruments,
		psy_audio_instrumentindex_make(groupslot, psy_ui_listbox_cur_sel(
			sender)));
