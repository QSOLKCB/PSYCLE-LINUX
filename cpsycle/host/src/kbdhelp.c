...
/* prototypes */
static void kbdhelp_build_tabbar(KbdHelp*);
static void kbdhelp_on_tabbar_change(KbdHelp*, psy_ui_Component* sender,
	int tabindex);
static void kbdhelp_set_cmd_section(KbdHelp*, uintptr_t index);
...
{	
	...
	closebar_set_cmd(&self->close_bar, "general", psy_eventdrivercmd_make_cmd(
	...
	psy_signal_connect(&self->tabbar.signal_change, self,
		kbdhelp_on_tabbar_change);	
	kbdhelp_build_tabbar(self);
}

void kbdhelp_update(KbdHelp* self)
{
	assert(self);
...
void kbdhelp_build_tabbar(KbdHelp* self)
{		
...
void kbdhelp_on_tabbar_change(KbdHelp* self, psy_ui_Component* sender,
	int tabindex)
{	
	assert(self);

	kbdhelp_set_cmd_section(self, tabindex);
}

void kbdhelp_set_cmd_section(KbdHelp* self, uintptr_t index)
{
	const psy_Property* cmds;
