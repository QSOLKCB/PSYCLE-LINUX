	...
	psy_ui_Component* parent, SeqEditState* state)
{
	...
	psy_ui_button_set_svg(&self->insert, psy_ui_app_svg(psy_ui_app(), "img.add"));
	psy_ui_button_init_connect(&self->del, &self->top, self,
		seqeditorheaderdescbar_ondeletetrack);
	psy_ui_button_set_svg(&self->del, psy_ui_app_svg(psy_ui_app(), "img.minus"));
	...
	psy_ui_button_set_svg(&self->up, psy_ui_app_svg(psy_ui_app(), "img.arrow-up"));
	psy_ui_button_init_connect(&self->down, &self->top, self,
		seqeditorheaderdescbar_onmovetrackdown);
	psy_ui_button_set_svg(&self->down, psy_ui_app_svg(psy_ui_app(), "img.arrow-down"));
