...
/* prototypes */
static void psy_ui_appstyles_init_dark_theme(psy_ui_Styles*, bool keepfont);
...
{	
	...
	case psy_ui_LIGHTTHEME:
		...
		break;
	default:
		psy_ui_appstyles_init_dark_theme(self, keepfont);
		break;
	}	
}

/* DarkTheme */
void psy_ui_appstyles_init_dark_theme(psy_ui_Styles* self,
	bool keepfont)
{
	psy_ui_Style* style;
	...
	psy_ui_border_set_colour(&style->border,
	...
	psy_ui_style_set_margin_em(style, 0.0, 0.3, 0.0, 0.0);		
	psy_ui_border_init_solid_radius(&style->border, material.secondary, 6.0);
	psy_ui_styles_set_style(self, psy_ui_STYLE_TAB_FOCUS,
		"tab::focus", style);
	/* tab_label */
	style = psy_ui_style_alloc_init();
	psy_ui_style_set_colour(style,
	...
	psy_ui_border_init_solid(&style->border,
		psy_ui_colour_weighted(material.onsurface, material.medium));
	psy_ui_style_set_padding_px(style, 1.0, 1.0, 1.0, 1.0);
	psy_ui_styles_set_style(self, psy_ui_STYLE_SLIDERPANE_FOCUS, "sliderpane::focus", style);
	/* sliderthumb */
	style = psy_ui_style_alloc_init();
	psy_ui_style_set_colours(style,
	...
	psy_ui_border_init_solid_radius(&style->border, material.secondary, 6.0);
	// psy_ui_style_set_padding_em(style, 0.25, 1.0, 0.25, 1.0);		
	psy_ui_styles_set_style(self, psy_ui_STYLE_FOCUS,
		"::focus", style);
}
