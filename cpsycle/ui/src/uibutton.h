...
** @brief Displays a text field and/or an icon.
**
** @details
...
**	  psy_ui_button_allow_right_click(&example.button);
...
void psy_ui_button_init_exchange(psy_ui_Button*, psy_ui_Component* parent,
	psy_Property*);
void psy_ui_button_init_text(psy_ui_Button*, psy_ui_Component* parent,
	const char* text);
void psy_ui_button_init_resource(psy_ui_Button*, psy_ui_Component* parent,
	const char* key);
void psy_ui_button_init_text_resource(psy_ui_Button*, psy_ui_Component* parent,
...
void psy_ui_button_init_resource_connect(psy_ui_Button*, psy_ui_Component* parent,
	const char* key, void* context, void* fp);
void psy_ui_button_init_check(psy_ui_Button*, psy_ui_Component* parent,
	const char* text);
void psy_ui_button_init_check_connect(psy_ui_Button*, psy_ui_Component* parent,
	const char* text, void* context, void* fp);
...
void psy_ui_button_set_svg(psy_ui_Button*, const psy_ui_SVG*);
void psy_ui_button_set_svg_selected(psy_ui_Button*, const psy_ui_SVG*);
...
void psy_ui_button_prevent_text(psy_ui_Button*);
void psy_ui_button_set_click_mode(psy_ui_Button*, psy_ui_ClickMode);
...
INLINE uintptr_t psy_ui_button_click_state(const psy_ui_Button* self)
{
	assert(self);
...
INLINE void psy_ui_button_allow_right_click(psy_ui_Button* self)
{
	assert(self);
