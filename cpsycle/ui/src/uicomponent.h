...
#define psy_ui_POPUP		3
	...
	typedef psy_List* (*psy_ui_fp_component_children)(struct psy_ui_Component*,
		int recursive, int only_visible);
	...
	typedef struct psy_ui_ComponentVTable {
		...
		psy_ui_fp_component on_language_changed;
		psy_ui_fp_component on_focus;
		psy_ui_fp_component on_focus_lost;
	...
	typedef struct psy_ui_Component {
		...
		char_dyn_t* tooltip;
		struct psy_ui_Component* splitter_;
		struct psy_ui_Component* close_;
		struct psy_ui_Component* sizer_;
		struct psy_ui_Component* frame_icons_;
		psy_ui_Size frame_size_;
		struct psy_EventDriver* kbd_;		
	} psy_ui_Component;
	...
	psy_List* psy_ui_component_children(psy_ui_Component*, int recursive, int visible);
	...
	typedef psy_List* (*psy_ui_fp_componentimp_dev_children)(
		struct psy_ui_ComponentImp*, int recursive, int visible);
	...
	*/
	...
	{
		if (psy_ui_component_parent(self) != parent) {
	...
	void psy_ui_component_float(psy_ui_Component*);
	psy_ui_Component* psy_ui_component_next_tab_index(psy_ui_Component*);
	psy_ui_Component* psy_ui_component_prev_tab_index(psy_ui_Component*);
