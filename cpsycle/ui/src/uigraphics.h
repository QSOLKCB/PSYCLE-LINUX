...
typedef void (*psy_ui_fp_graphics_drawsolidpolygon)(struct psy_ui_Graphics*,
	psy_ui_RealPoint*, uintptr_t numpoints, psy_ui_Colour inner, psy_ui_Colour outter);
...
INLINE void psy_ui_graphics_draw_solid_polygon(psy_ui_Graphics* self,
	psy_ui_RealPoint* pts, uintptr_t numpoints, psy_ui_Colour inner, psy_ui_Colour outter)
{
