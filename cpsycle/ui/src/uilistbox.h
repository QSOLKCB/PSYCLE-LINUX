...
INLINE uintptr_t psy_ui_listitem_id(const psy_ui_ListItem* self)
{
    assert(self);
...
INLINE void psy_ui_listitem_set_id(psy_ui_ListItem* self, uintptr_t id)
{
    assert(self);
...
uintptr_t psy_ui_listboxpane_add_text(psy_ui_ListBoxPane*, const char* text);
void psy_ui_listboxpane_set_text(psy_ui_ListBoxPane*, const char* text,
	uintptr_t index);
void psy_ui_listboxpane_set_cur_sel(psy_ui_ListBoxPane*, uintptr_t index);
uintptr_t psy_ui_listboxpane_cur_sel(const psy_ui_ListBoxPane*);
...
uintptr_t psy_ui_listbox_add_text(psy_ui_ListBox*, const char* text);
void psy_ui_listbox_set_text(psy_ui_ListBox*, const char* text,
    uintptr_t index);
void psy_ui_listbox_text(psy_ui_ListBox* self, char* text,
    uintptr_t index);
void psy_ui_listbox_clear(psy_ui_ListBox*);
void psy_ui_listbox_set_cur_sel(psy_ui_ListBox*, uintptr_t index);
uintptr_t psy_ui_listbox_cur_sel(const psy_ui_ListBox*);
void psy_ui_listbox_add_sel(psy_ui_ListBox*, uintptr_t index);
void psy_ui_listbox_sel_items(const psy_ui_ListBox*, uintptr_t* items,
    uintptr_t maxitems);
uintptr_t psy_ui_listbox_sel_count(const psy_ui_ListBox*);
void psy_ui_listbox_set_char_number(psy_ui_ListBox*, double num);
uintptr_t psy_ui_listbox_count(const psy_ui_ListBox*);
psy_ui_ListItem* psy_ui_listbox_at(psy_ui_ListBox*, uintptr_t index);
const psy_ui_ListItem* psy_ui_listbox_at_const(const psy_ui_ListBox*,
    uintptr_t index);
