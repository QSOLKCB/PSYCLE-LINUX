...
void psy_ui_backgroundrepeat_init(psy_ui_BackgroundRepeat* self)
{
	self->horizontal = psy_ui_REPEAT;
	self->vertical = psy_ui_REPEAT;
}
...
{
	psy_ui_BackgroundRepeat rv;

	rv.horizontal = horizontal;
	rv.vertical = vertical;
	return rv;
}
...
void psy_ui_background_init(psy_ui_Background* self)
{
	...
	psy_ui_backgroundrepeat_init(&self->repeat);
