...
host-block guard before the chorus path, and standalone makefile output/clean hygiene.
Positive-count synthesis, filter, distortion and chorus equations are unchanged.
EOF
