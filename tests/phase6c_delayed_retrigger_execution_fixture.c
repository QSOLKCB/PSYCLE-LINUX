...
** Project-authored Phase 6C delayed/retrigger execution witness.
**
...
#define TITLE "PSYCLE-LINUX Phase 6C delayed/retrigger execution witness"
#define BPM 137.0
#define LPB 8
#define TPB 24
...
{
    fprintf(stderr, "phase6c-delayed-retrigger-execution-fixture: FAIL: %s\n", message);
    return 1;
}
...
int main(int argc, char** argv)
{
    ...
    if (snprintf(path, sizeof(path),
            "%s/phase6c-delayed-retrigger-execution.psy", argv[1])
            >= (int)sizeof(path))
    ...
    puts("phase6c-delayed-retrigger-execution-fixture: PASS");
    return 0;
}
